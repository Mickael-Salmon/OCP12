...
def create_employees():
    """
    Populate the Employee table in the database from data found in `data/employees.json`.
    """
...
def create_clients():
    """
    Populate the Client table in the database from data found in `data/clients.json`.
    """
...
def create_contracts():
    """
    Populate the Contract table in the database from data found in `data/contracts.json`.
    """
...
def create_events():
    """
    Populate the Event table in the database from data found in `data/events.json`.
    """
